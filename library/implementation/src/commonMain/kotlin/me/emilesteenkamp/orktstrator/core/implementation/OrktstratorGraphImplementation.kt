...
internal class OrktstratorGraphImplementation<TRANSIENT_STATE, FINALISED_STATE>
private constructor(
    private val entryPoint: Step<*, *>,
    private val map: Map<Step<*, *>, OrktstratorGraph.StepEngine<TRANSIENT_STATE, FINALISED_STATE, *, *>>,
) : OrktstratorGraph<TRANSIENT_STATE, FINALISED_STATE> where TRANSIENT_STATE : State.Transient,
    ...
    private fun <INPUT, OUTPUT> OrktstratorGraph.StepEngine<TRANSIENT_STATE, FINALISED_STATE, *, *>.unsafeCast() =
        this as OrktstratorGraph.StepEngine<TRANSIENT_STATE, FINALISED_STATE, INPUT, OUTPUT>

    internal class BuilderImplementation<TRANSIENT_STATE, FINALISED_STATE> : OrktstratorGraph.Builder<TRANSIENT_STATE, FINALISED_STATE>
            where TRANSIENT_STATE : State.Transient,
                  FINALISED_STATE : State.Final
    {
        private val stepDefinitionList = mutableListOf<OrktstratorGraph.Builder.StepDefinition<TRANSIENT_STATE, FINALISED_STATE, *, *>>()

        override fun <INPUT, OUTPUT> add(stepDefinition: OrktstratorGraph.Builder.StepDefinition<TRANSIENT_STATE, FINALISED_STATE, INPUT, OUTPUT>) {
            stepDefinitionList.add(stepDefinition)
        }

        override fun build(): OrktstratorGraph<TRANSIENT_STATE, FINALISED_STATE> = OrktstratorGraphImplementation(
            entryPoint = stepDefinitionList.firstOrNull()?.step
                ?: throw OrktstratorException.DefinitionException.NoStepsDefined(),
        ...
        private fun <INPUT, OUTPUT> toStepEngine(
            current: OrktstratorGraph.Builder.StepDefinition<TRANSIENT_STATE, FINALISED_STATE, INPUT, OUTPUT>,
            next: OrktstratorGraph.Builder.StepDefinition<TRANSIENT_STATE, FINALISED_STATE, *, *>?
        ): OrktstratorGraph.StepEngine<TRANSIENT_STATE, FINALISED_STATE, INPUT, OUTPUT> {
            return object : OrktstratorGraph.StepEngine<TRANSIENT_STATE, FINALISED_STATE, INPUT, OUTPUT> {
